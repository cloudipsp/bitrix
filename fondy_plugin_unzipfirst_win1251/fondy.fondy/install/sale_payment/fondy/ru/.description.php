...
$MESS["FONDY_DESC_PRICE_CURRENCY"] = "Внимание! Это значение должно соответствовать валюте вашего мерчанта";
$MESS["FONDY_RESPONSE_URL"] = "Ссылка возврата клиента";
$MESS["FONDY_DESC_RESPONSE_URL"] = "Ссылка, на которую вернется клиент после завершения платежа. Например http://{yourdomain}/personal/order/";
$MESS["FONDY_SERVER_CALLBACK_URL"] = "Ссылка ответа платежной системы";
$MESS["FONDY_DESC_SERVER_CALLBACK_URL"] = "Ссылка, на которую зайдет платежная система для завершения заказа. Например http://{yourdomain}/bitrix/tools/fondy_result/fondy_result.php";
