...
$MESS["OPLATA_DESC_SERVER_CALLBACK_URL"] = "Ссылка, на которую зайдет платежная система для завершения заказа.<br>Например http://{yourdomain}/bitrix/tools/oplata_result.php";
